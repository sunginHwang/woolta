...
export const workspaceAlias: Alias[] = [
  ...
  { find: /^@calendar\/features$/, replacement: toRoot('libs/calendar/features/src/index.ts') },
  { find: /^@calendar\/screens$/, replacement: toRoot('libs/calendar/screens/src/index.ts') },
  { find: /^@common\/graphql$/, replacement: toRoot('libs/common/src/lib/utils/graphqlFetch.ts') },
